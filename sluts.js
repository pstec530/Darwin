function dealer() {
    ...
    if (dealerHand === 1) {
        ...
        dealerHand = { cards: "6 and 9", value: 100 };
...
function computer() {
    ...
    if (computerHand === 1) {
        ...
        computerHand = { cards: "6 and 9", value: 100 };
    ...
    if (userHoldDrop.toLowerCase() === "d" || userHoldDrop.toLowerCase() === "drop") {
        ...
        if (computerChoice() === "hold") {
            ...
            if (playerHand.value === computerHand.value) {
                ...
                alert("Darwin had a " + computerHand.cards + ", and you had a " + playerHand.cards + ". Your are an idiot, Darwin beat you, now you have to pay free weed.");
                chips.C += chips.pot;
                chips.P -= chips.pot;
                return chips;
            }
...
function gameOn() {
    ...
    if (chips.C <= 0) {
        ...
        alert("You lost because you are sh^t, you have no more chips, no pay no play!");
        chips.P = 10;
        chips.C = 10;
        chips.pot = 0;
        return chips;
